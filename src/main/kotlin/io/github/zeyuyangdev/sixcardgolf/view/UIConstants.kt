...
const val PLAYER_LABEL_HEIGHT = 30

const val PPT_DIS_TO_TOP = 20
const val PPL_DIS_TO_LEFT = PPT_DIS_TO_TOP * 1.5
...
const val PLAYER_LABEL_FONT_SIZE = 25
...
// GameScene:
const val STACKS_LABEL_WIDTH = PMC_WIDTH // 300
const val STACKS_LABEL_HEIGHT = 50
const val STACKS_LABEL_POS_X = 0
const val STACKS_LABEL_POS_Y = CARD_HEIGHT - STACKS_LABEL_HEIGHT * 0.2
val STACKS_LABEL_FONT = Font(
    size = 18,
    color = Color.WHITE,
    fontWeight = Font.FontWeight.SEMI_BOLD
)
const val STACKS_LABEL_TEXT = "     Hand            Draw          Discard"

const val INSTRUCTION_LABEL_WIDTH = PMC_WIDTH * 1.5
const val INSTRUCTION_LABEL_HEIGHT = STACKS_LABEL_HEIGHT
const val INSTRUCTION_LABEL_POS_X = PMC_POS_X - (INSTRUCTION_LABEL_WIDTH - PMC_WIDTH) / 2
const val INSTRUCTION_LABEL_POS_Y = PMC_POS_Y - INSTRUCTION_LABEL_HEIGHT * 0.8

val MIDDLE_LABEL_BG_VISUAL = ColorVisual.TRANSPARENT

const val INSTRUCTION_FONT_SIZE = 18
val DEFAULT_INSTRUCTION_FONT = Font(size = INSTRUCTION_FONT_SIZE, color = Color.WHITE, fontWeight = Font.FontWeight.SEMI_BOLD)
val PINK_INSTRUCTION_FONT = Font(size = INSTRUCTION_FONT_SIZE, color = Color.PINK, fontWeight = Font.FontWeight.SEMI_BOLD)
val GREEN_INSTRUCTION_FONT = Font(size = INSTRUCTION_FONT_SIZE, color = Color.GREEN, fontWeight = Font.FontWeight.SEMI_BOLD)
val RED_INSTRUCTION_FONT = Font(size = INSTRUCTION_FONT_SIZE, color = Color.RED, fontWeight = Font.FontWeight.SEMI_BOLD)
